 ...
 * <dl>
 *  <dt>Class:</dt>
 *  <dd>At this level, the configuration will be applied to all fields (properties) in given
 *   class unless the configuration will overridden on field level.</dd>
 *  <dt>Property:</dt>
 *  <dd>At this level, the configuration will be applied only to given field. It overrides
 *   behavior applied at class level</dd>
 * </dl>
 */
